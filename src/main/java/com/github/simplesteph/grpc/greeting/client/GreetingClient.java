...
public class GreetingClient {
    ...
    public static void main(String[] args) throws SSLException {
        ...
        System.out.println("Welcome to DENK-IT");
...
//        doUnaryCall(secureChannel);
    ...
    private void doClientStreamingCall(ManagedChannel channel) {
        ...
        // Normal BlockingStub yapılsaydı longGreet bulunamayacaktı.
        // Streaming Client olduğu için bulunamıyor.
        // O yüzden asynchronous şekilde tanımlanmalı
        // Eğer istersek üstteki Client'ları da asynchronous tanımlayabiliriz.
        // GreetServiceGrpc.GreetServiceBlockingStub greetClient = GreetServiceGrpc.newBlockingStub(channel);

        // create an asynchronous client
        GreetServiceGrpc.GreetServiceStub asyncClient = GreetServiceGrpc.newStub(channel);

        CountDownLatch latch = new CountDownLatch(1); // asynchronous şekilde çalışan bu yapıları beklemesi için yapılan common bir pattern

        StreamObserver<LongGreetRequest> requestObserver = asyncClient.longGreet(new StreamObserver<LongGreetResponse>() {

            //Alttaki service'leri yine otomatik atıyor.
        ...
        try {
            latch.await(3L, TimeUnit.SECONDS); // Ne kadar bekleyeceğini söylüyoruz
                                                       // ne zaman 0 olursa bu kadar süre kadar bekleyecek(3 sec)
        ...
        Arrays.asList("Stephane", "John", "Marc", "Patricia").forEach(
                name -> {
                    ...
                    requestObserver.onNext(GreetEveryoneRequest.newBuilder()
                            ...
                            .build());
                    try {
                        // Async Çalışmayı görebilmek için süreyi arttır.
                        Thread.sleep(1000);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
